...
class SettingsRepositoryImpl @Inject constructor(
    ...
    private val notificationStatusKey = booleanPreferencesKey("notifications")
    ...
    override fun getSettings(): Flow<Settings> {
        return context.dataStore.data
            .map { preferences ->
                ...
                val notificationStatus = preferences[notificationStatusKey] ?: Settings.DEFAULT_NOTIFICATIONS_ENABLED
    ...
    override suspend fun updateNotificationStatus(enabled: Boolean) {
        context.dataStore.edit { preferences ->
            preferences[notificationStatusKey] = enabled
        }    }
